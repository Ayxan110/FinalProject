...
namespace FinalProjectV2.Areas.Admin.Controllers
{
    ...
    public class PhotosController : Controller
    {
        ...
        public PhotosController(ProjectDbContext context)
        {
            _context = context;
        }
        ...
        {
            var projectDbContext = _context.Photos.Include(p => p.Product);
        ...
        {
            ViewData["ProductId"] = new SelectList(_context.Products, "Id", "MainPhoto");
            return View();
        }
